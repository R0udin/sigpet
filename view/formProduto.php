<div class="container">
    ...
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?> ?controller=ProdutosController&<?php echo isset($produto->id) ? "method=atualizar&id={$produto->id}" : "method=salvar"; ?>" method="post" >
