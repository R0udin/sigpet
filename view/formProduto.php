<div class="container">
    <form action="?controller=ProdutosController&<?php echo isset($produto->id, $produtos[0]->id ) ? "method=atualizar&id={$produto->id, $produtos[0]->id}" : "method=salvar"; ?>" method="post" >
