    ...
    <form action="?controller=ClientesController&<?php echo isset($cliente->id) ? "method=atualizar&id={$cliente->id}" : "method=salvar"; ?>" method="post" >
        <div class="card" style="top:40px">
            ...
            <div class="form-group form-row">
                ...
                <input type="text" class="form-control col-sm-8" name="CPF_CLIENTE" id="CPF_CLIENTE" value="<?php
            ...
            <div class="form-group form-row">
                ...
                <input type="text" class="form-control col-sm-8" name="RG_CLIENTE" id="RG_CLIENTE" value="<?php
            ...
            <div class="form-group form-row">
                ...
                <input type="text" class="form-control col-sm-8" name="DT_CADASTRO" id="DT_CADASTRO" value="<?php
            ...
            <div class="form-group form-row">
                ...
                <input type="text" class="form-control col-sm-8" name="CNPJ_CLIENTE" id="CNPJ_CLIENTE" value="<?php
            ...
            <div class="form-group form-row">
                ...
                <input type="text" class="form-control col-sm-8" name="CELULAR" id="CELULAR" value="<?php
