<div class="row">
  <div class="col s12 m4">
    <div class="icon-block">
      <h2 class="center brown-text"><a href="RelVendaPorData.php"><i class="material-icons">date_range</a></i></h2>
      <h5 class="center">Relatório de venda por data</h5>

      <p class="light">Relatório de vendas em que é possível  por um período específico.</p>
    </div>
  </div>
